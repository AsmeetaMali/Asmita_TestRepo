...
class ResearchAssistantAgent:
    def __init__(self):
      ...
      #  self.tools_by_name = {tool.name: tool for tool in tools_list}
        ...
        self._initilize_mcp_tools()
    
    def _initilize_mcp_tools(self):
        ...
        try:
            ...
            print(f"\n Successfully connected with MCP Server, Fetched {len(self.tools_list)} tools")
        ...
        return {
            "messages": [
                self.llm_with_tools.invoke(
                    ...
                    Your task is to look for complex topics , refernces
                    from academic and online databases and generate high 
                    qualitty summeries that can help me start writimg my 
                    literrature review 

                    Follow this process:

                    1. you have tools that can help with web searcches. 
                    Use them to find links or extract detailed web content.
                     Refer to blogs , articles & doumentation   
                     
                    2. You have access to research repositories as well, use them 
                    to extract paper content and generate educated summeries
                    
                    3. Compare all the found content, create technical breakdown, 
                    compare introduction, to provide the said output.
